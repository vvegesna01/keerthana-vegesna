...
I've been spending a lot of time studying those sys design concepts: CDNs, load balancers, object storage, etc. I understand them well enough to draw out these diagrams and then I realized I could try to make an interactive web app out of this. 

So I built [Where Does Your Data Go?](https://github.com/vvegesna01/Where-Does-Your-Data-Go) an interactive visualization of what actually happens to your data when you ***post a photo, send a message, search for something, or stream a video***. This post is about the research that went into it.
